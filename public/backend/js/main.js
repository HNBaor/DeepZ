...
const bigLi = document.querySelectorAll('.deepz-admin-left-content > ul >li>a.a-contain-sub');
...
//     if (event.target != document.querySelector('.deepz-admin-left-content > ul >li>a.a-contain-sub').children) {
//         for (let a = 0; a < bigLi.length; a++) {
//             bigLi[a].parentNode.querySelector('ul').setAttribute('style', 'height: 0px')
