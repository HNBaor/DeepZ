    ...
    <div class="container">
        <div class="row-flex row-flex-header">
            ...
            <div class="header-logo">
                <a href="/" class="logo"><img src="/frontend/images/Virtual Reality Logo _ VR logo.jpg" alt=""></a>
            </div>
            <div class="header-logo-mobile">
                <a href=""><img src="/frontend/images/Virtual Reality Logo _ VR logo.jpg" alt=""></a>
            </div>
            <nav>
                <ul>
                    ...
                    <li>
                        ...
                        <div class="header-cart-box-text">
                            ...
                            <div class="header-cart-box-text-bottom">
                                <p class="p-product-smaller">{{number_format($item -> sale_price)}}đ<span class="span-product-smaller"
                                        style="text-decoration: line-through; margin-left: 3px;">{{number_format($item-> price)}}đ</span> </p>
