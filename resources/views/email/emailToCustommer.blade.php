<h1 style="font-size: medium;">Xác nhận đơn hàng: <span style="font-size: larger; color: brown;">{{$success -> name}}(#{{$success -> id}})</span></h1>

<h2 style=" font-size: medium; font-weight: normal;">Chi tiết đơn hàng:</h2>
...
text-align: center;">
    ...
    <tr style="font-weight: bold;">
        <td style="padding: 6px 12px;" style="text-align: center;" colspan="5"> Tổng tiền</td>
        <td style="padding: 6px 12px;">{{number_format($totals)}}</td>
    </tr>
</table>
<h2 style=" font-size: medium; font-weight: normal;">Thông tin giao hàng:</h2>
...
<h2 style=" font-size: medium; font-weight: lighter;">Xác nhận đơn hàng</h2> <a href="{{ route('confirm_order_cus', ['id'=> $success->id,'token' => $success -> token]) }}">Tại đây</a>